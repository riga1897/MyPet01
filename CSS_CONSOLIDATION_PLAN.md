...
|------|------------|--------|
| 1 | Создать `components.css`, подключить | ✅ Готово |
| 2 | `.btn-danger`, `.alert-success` | ✅ Готово |
| 3 | `.dropdown-menu`, `.dropdown-toggle` | ✅ Готово |
| 4 | `.btn-primary`, `.btn-secondary` + варианты (sm, lg, full) | ✅ Готово |
| 5 | `.form-input` | ✅ Готово |
| 6 | `.mode-btn` → `.btn-primary-sm`, `.btn-tab-inactive` | ✅ Готово |
